...
Anyway, please consider that in 2022 you can do the same thing easily and without jQuery and waypoint.js (with [AlpineJS](https://github.com/alpinejs/alpine), for example).
